    ...
    <div class="footer-content">
      ...
      <div class="meta">
        <div class="power link" >
          ...
          <a class="name" href="https://vitepress.dev/" target="_blank">VitePress</a>
          <span style="white-space: pre;"> & </span>
          <a class="name" href="https://github.com/imsyy/vitepress-theme-curve" target="_blank">Curve Theme</a>
        </div>
